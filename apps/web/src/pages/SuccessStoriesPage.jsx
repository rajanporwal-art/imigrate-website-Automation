...
function SuccessStoriesPage() {
  ...
  const successStories = [
    ...
    },
    {
      ...
      testimonial: 'My employer wanted to sponsor my permanent residence in Australia and the process seemed complex. iMigrate Solutions handled everything professionally, coordinating between my employer and the immigration authorities. I highly recommend their services.',
    ...
    },
    {
      ...
      visaType: 'C11 Entrepreneur Work Permit',
      testimonial: 'As a Singaporean entrepreneur, expanding into Canada was a strategic decision. iMigrate Solutions made the immigration process straightforward and stress-free. Their knowledge of the C11 work permit was exceptional and their communication was always timely.',
    ...
    },
    {
      ...
      testimonial: 'After exploring multiple immigration options, iMigrate Solutions identified the Provincial Nominee Program as the ideal pathway for my professional profile. Their strategic advice and thorough documentation support gave me confidence throughout the process.',
    ...
    },
    {
      ...
      country: 'Malaysia → Australia',
      visaType: 'Skilled Independent Visa (189)',
      testimonial: 'The team at iMigrate Solutions was incredibly thorough in assessing my eligibility for Australian skilled migration. They helped me understand the points system and guided me toward achieving the score needed for my application. Professional service throughout.',
    ...
    },
    {
      ...
      testimonial: 'Relocating my business from Singapore to Australia was a major step. iMigrate Solutions provided expert guidance on the Business Innovation visa, helping me understand all requirements and prepare a comprehensive application. Their team was knowledgeable and supportive.',
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              >
                ...
                <p className="text-lg leading-relaxed mb-8 opacity-90">
                  Join thousands of satisfied clients who have achieved their immigration goals with iMigrate Solutions. Start your journey today with a free eligibility assessment.
                </p>
